...
def CallMySql2():
    ...
    poetry['yiwen_'+str(key)] = langconv.Converter('zh-hant').convert(poetry['yiwen_'+str(key)])
    poetry['name'] = langconv.Converter('zh-hant').convert(poetry['name'])
    poetry['sentense_'+str(key)] = langconv.Converter('zh-hant').convert(poetry['sentense_'+str(key)])
